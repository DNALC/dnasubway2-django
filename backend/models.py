...
class CoreMetricsResult(models.Model):
    ...
    evenness_raincloud = models.FileField(upload_to="coremetrics_files/", blank=True, null=True)
    ...
    faith_pd_raincloud = models.FileField(upload_to="coremetrics_files/", blank=True, null=True)
    ...
    observed_features_raincloud = models.FileField(upload_to="coremetrics_files/", blank=True, null=True)
    ...
    shannon_raincloud = models.FileField(upload_to="coremetrics_files/", blank=True, null=True)
